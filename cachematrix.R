...
## makeCacheMatrix creates a special “matrix”, a list containing a
## function to: 1. set the value of the matrix, 2. get the value of the ## matrix, 3. set the value of the inverse, 4. get the value of the
## inverse
